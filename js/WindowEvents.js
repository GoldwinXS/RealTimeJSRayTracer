...
export function onWindowResize(event) {
  ...
  sceneSettings.pathTracing.uniforms.uResolution.value.x =
    sceneSettings.context.drawingBufferWidth;
  sceneSettings.pathTracing.uniforms.uResolution.value.y =
    sceneSettings.context.drawingBufferHeight;

  sceneSettings.pathTracing.renderTarget.setSize(
    sceneSettings.context.drawingBufferWidth,
    sceneSettings.context.drawingBufferHeight
  );
  sceneSettings.screenCopy.renderTarget.setSize(
    sceneSettings.context.drawingBufferWidth,
    sceneSettings.context.drawingBufferHeight
  );
  ...
  sceneSettings.fovScale =
    sceneSettings.worldCamera.fov * 0.5 * (Math.PI / 180.0);
  sceneSettings.pathTracing.uniforms.uVLen.value = Math.tan(
    sceneSettings.fovScale
  );
  sceneSettings.pathTracing.uniforms.uULen.value =
