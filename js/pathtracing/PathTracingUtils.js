...
export function setupUniforms({
    ...
    pathTracing.uniforms.tBlueNoiseTexture = { type: "t", value: blueNoiseTexture };
...
export function updateAnimatedPathtracingUniforms({ pathTracing, elapsedTime, cameraIsMoving, sampleCounter, frameCounter }) {
...
export default { setupUniforms, setupRenderTargets, handleSceneDynamism, updateAnimatedPathtracingUniforms, loadShaderAndCreateMesh }