...
export let joystickDeltaX = 0;
export let joystickDeltaY = 0;
export let pinchWidthX = 0;
export let pinchWidthY = 0;
export let button1Pressed = false;
export let button2Pressed = false;
export let button3Pressed = false;
export let button4Pressed = false;
export let button5Pressed = false;
export let button6Pressed = false;

let stickElement = null;
let baseElement = null;
export let button1Element = null;
export let button2Element = null;
export let button3Element = null;
export let button4Element = null;
export let button5Element = null;
export let button6Element = null;
...
export let MobileJoystickControls = function (opts) {
    opts = opts || {};
...
export default {
    pinchWidthX, pinchWidthY, MobileJoystickControls
}